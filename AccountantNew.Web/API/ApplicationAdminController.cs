...
namespace AccountantNew.Web.API
{
    ...
    public class ApplicationAdminController : ApiControllerBase
    {
        ...
        {
            int totalRow = 0;
            IEnumerable<ApplicationUser> model = _appUserService.GetAdmin(keyword, page, pageSize, out totalRow);
        ...
        [Route("update")]
        [AuthorizeApi(Role = "Admin", Action = "Update")]
        [HttpPut]
        ...
        [Route("delete")]
        [AuthorizeApi(Role = "Admin", Action = "Delete")]
        [HttpDelete]
